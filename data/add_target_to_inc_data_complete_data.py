...
def make_dataset(root_data_dir, complete_data_dir, incomplete_data_dir, results_dir):
    ...
    for k, v in files_dictionary.items():
        ...
        for comp_v_i in ['test.tsv', 'train.tsv']:
...
def init_args():
    ...
    parser.add_argument('--incomplete_data_dir', type=str, default="complete_data",  #"incomplete_data_tfidf_lower_0.8",
                        help='Subdirectory with incomplete data')
    parser.add_argument('--results_dir', type=str, default="complete_data_with_target",

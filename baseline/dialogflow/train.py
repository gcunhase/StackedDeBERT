...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--dataset_name',
        help='Options: [ChatbotCorpus, AskUbuntuCorpus, WebApplicationsCorpus, snips]',
    ...
    for dataset in dataset_arr:
        ...
        for intent_id, intent_name in tags.items():
            ...
            # Data dir path
            if 'snips' in dataset:
                train_data_dir_path = data_dir_path + "{}/train_dialogflow_{}.csv".format(dataset.lower(), intent_name)
            else:
                train_data_dir_path = data_dir_path + "nlu_eval_{}/train_dialogflow_{}.csv".format(dataset.lower(),
                                                                                                   intent_name)

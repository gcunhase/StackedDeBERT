...
if __name__ == '__main__':
    ...
    for dataset in dataset_arr:
        ...
        for intent_id, intent_name in tags.items():
            ...
            # Data dir path
            if 'snips' in dataset:
                test_data_dir_path = data_dir_path + "{}/test_dialogflow_{}.csv".format(dataset.lower(),
                                                                                        intent_name)
            else:
                test_data_dir_path = data_dir_path + "nlu_eval_{}/test_dialogflow_{}.csv".format(dataset.lower(),
                                                                                                 intent_name)

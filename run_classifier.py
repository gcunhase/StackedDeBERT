...
from models.pytorch_pretrained_bert.optimization import BertAdam
from models.pytorch_pretrained_bert.file_utils import PYTORCH_PRETRAINED_BERT_CACHE
...
# ======== EARLY STOPPING ========
def evaluate_model(args, model, device, eval_dataloader, eval_examples_dataloader, tr_loss, nb_tr_steps, global_step, batches=None):
        ...
        for _ in trange(int(args.num_train_epochs), desc="Epoch"):
            ...
            for step, batch in enumerate(tqdm(train_dataloader, desc="Iteration")):
                ...
                if (step + 1) % args.gradient_accumulation_steps == 0:
                    ...
                    # ======== EARLY STOPPING ========
                    eval_loss, _, _, _, _, _, _ = evaluate_model(args, model, device, eval_dataloader,
                                                                 eval_examples_dataloader, tr_loss, nb_tr_steps,
                                                                 global_step, batches=4)
